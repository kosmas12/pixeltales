...
Public Domain (according to [GLAD's README file](https://github.com/Dav1dde/glad#license))

Pixeltales also uses `stb_image.h` for its texture loading, which
is licensed under the public domain (according to [the repo I got it from](https://github.com/nothings/stb))
